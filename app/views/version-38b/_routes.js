...
router.post('/duplicate-prc', function (req, res) {
  ...
  if (selectedRadio === "yes"){
    res.redirect('/version-38b/pb7/v3/add-prc-institution-details-duplicate')
  }ƒ

  if (selectedRadio === "no"){
    res.redirect('/version-38b/pb7/v3/entitlements-treatments-with-prc')
  }


  else {
    res.redirect('/version-38b/pb7/v3/add-prc-duplicate')
  }
...
router.post('/entitlement-type-duplicate-v3', function (req, res) {
  ...
  if (selectedRadio === "S2/E112"){
    res.redirect('/version-38b/pb7/v3/add-new-entitlement-duplicate')
  }
  ...
  if (selectedRadio === "PRC"){
    res.redirect('/version-38b/pb7/v3/add-prc-details-duplicate')
  }
...
router.post('/entitlement-type-v4', function (req, res) {
  ...
  if (selectedRadio === "S2/E112"){
    res.redirect('/version-38b/s2-details')
  }
...
router.post('/entitlement-type-v3', function (req, res) {
  ...
  if (selectedRadio === "S2/E112"){
    res.redirect('/version-38b/pb7/v3/add-new-entitlement')
  }
  ...
  if (selectedRadio === "PRC"){
    res.redirect('/version-38b/pb7/v3/add-prc-details')
  }
...
router.post('/entitlement-type-v2', function (req, res) {
  ...
  if (selectedRadio === "S2/E112"){
    res.redirect('/version-38b/pb7/v2/add-new-entitlement')
  }
  ...
  if (selectedRadio === "PRC"){
    res.redirect('/version-38b/pb7/v2/add-prc-details')
  }
...
router.post('/entitlement-type', function (req, res) {
  ...
  if (selectedRadio === "S2/E112"){
    res.redirect('/version-38b/pb7/v1/add-new-entitlement')
  }
  ...
  if (selectedRadio === "PRC"){
    res.redirect('/version-38b/pb7/v1/add-prc-details')
  }
