...
router.post([/create-new-resubmission/], function(req, res) {
  ...
  res.redirect('/version-39a/uk-claims/resubmissions/confirmation-resubmission-created');
});
...
router.post([/confirm-partially-maintained-and-partially-withdrawn-months/], function(req, res) {
  ...
  res.redirect('/version-39a/uk-claims/resubmissions/reasons-to-partially-maintain-months');
});
...
router.post([/reasons-to-partially-maintain-months/], function(req, res) {
  ...
  if (reasonToPartiallyMaintainMonths === 'Information requested updated. [04]') {
    return res.redirect('/version-39a/uk-claims/resubmissions/select-information-requested-partially-maintain');
  }
...
router.post([/source-of-partial-withdrawal/], function(req, res) {
  ...
  res.redirect('/version-39a/uk-claims/resubmissions/reasons-to-partially-withdraw-months');
});
