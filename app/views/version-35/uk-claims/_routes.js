...
router.get([/create-new-uk-claim/], function(req, res) {
  ...
  res.render('version-35/uk-claims/create-new-uk-claim', {
...
res.redirect('/version-35/uk-claims/check-claim-details');
})

// Check claim details
router.post([/check-claim-details/], function(req, res) {
  res.redirect('/version-35/uk-claims/uk-claims-loading-new-claim');
})
...
router.post([/uk-claims-loading-new-claim/], function(req, res) {
  ...
  if (articleType === 'EHIC and PRC - Article 62' || articleType === "S2/E112 - Article 20.2") {
   ...
   res.redirect('/version-35/uk-claims/s1-claim-summary');
  }
});
