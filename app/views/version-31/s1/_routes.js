...
router.post([/person-search-results/], function(req, res){
  res.redirect('/version-31/s1/account/entitlement-content/dependant-person-summary');
})
...
router.post([/which-s1-entitlement/], function(req, res) {
  ...
  if (s1EntitlementType === 'E109') {
    res.redirect('/version-31/s1/account/dependant/s072-registration/entitlement-details');
  } else {
    res.redirect('/version-31/s1/account/dependant/s072-registration/entitlement-for');
  }
})
...
router.post([/dr-cancellation-cya/], function(req, res){
  ...
  res.redirect('/version-31/s1/account/dependant/entitlements-and-treatments');
})
...
router.post([/cancellation-source/], function(req, res) {
  ...
  res.redirect('/version-31/s1/account/cancellations/entitlement-end-date');
});
...
router.post([/cancellation-cya/], function(req, res){
  ...
  res.redirect('/version-31/s1/account/entitlements-and-treatments');
})
