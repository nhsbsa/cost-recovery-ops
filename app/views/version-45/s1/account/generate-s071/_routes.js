...
router.post('/enter-date-of-uk-residency', function(req, res) {
  ...
  res.redirect('/version-45/s1/account/generate-s071/select-citizen-status');
})
...
router.post('/select-citizen-status', function(req, res) {
  ...
  res.redirect('/version-45/s1/account/generate-s071/enter-member-state-details');
})
...
router.post('/enter-member-state-details', function(req, res) {
  ...
  res.redirect('/version-45/s1/account/generate-s071/search-for-institution-by-id');
})

// Search for the institution by ID
router.post('/search-for-institution-by-id', function(req, res) {

  res.redirect('/version-45/s1/account/generate-s071/search-for-institution-by-id-results');
})

// Search for the institution by name
router.post('/search-for-institution-by-name', function(req, res) {

  res.redirect('/version-45/s1/account/generate-s071/search-for-institution-by-name-results');
})
...
router.post('/enter-entitlement-period', function(req, res) {
  ...
  res.redirect('/version-45/s1/account/generate-s071/cya-generate-s071');
})
...
router.post('/cya-generate-s071', function(req, res) {
  ...
  res.redirect('/version-45/s1/account/generate-s071/confirmation-s071-generated');
})

// View new S071 in the 'Documents' section
router.post('/confirmation-s071-generated', function(req, res) {

  res.redirect('/version-45/s1/account/generate-s071/review-institution-details');
})
