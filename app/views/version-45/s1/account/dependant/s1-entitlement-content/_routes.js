...
router.post([/dr-change-s1-personal-details/], function(req, res){
 ...
 req.session.data['dr-new-s1-date-of-birth'] = S1DobDate;
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-reason-for-s1-personal-details-change');
});
...
router.post([/dr-reason-for-s1-personal-details-change/], function(req, res){
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-personal-details');
});
...
router.post([/dr-change-pin-s1/], function (req, res) {
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-reason-for-changing-s1-pin');
});
...
router.post([/dr-reason-for-changing-s1-pin/], function(req, res){
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-pin');
});
...
router.post([/dr-change-date-of-uk-residency-s1/], function (req, res) {
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-reason-for-changing-s1-date-of-uk-residency');
});
...
router.post([/dr-reason-for-changing-s1-date-of-uk-residency/], function(req, res){
  ...
  res.redirect('/version-45/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-date-of-uk-residency');
});
