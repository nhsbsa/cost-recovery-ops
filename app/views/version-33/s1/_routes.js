...
router.post(/which-entitlement/, function(req, res){
  res.redirect('/version-33/s1/s072-registration/which-s1-entitlement');
})
...
router.post([/which-s1-entitlement/], function(req, res) {
  ...
  if (s1EntitlementType === 'E109') {
    res.redirect('/version-33/s1/s072-registration/entitlement-details');
  } else {
    res.redirect('/version-33/s1/s072-registration/entitlement-for');
  }
})
...
router.post([/entitlement-details/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/search-institution-ID');
})

// Search by institution ID (to show functionality)
router.post([/search-institution-ID/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/institution-ID-search-results');
})

// Search by institution name (to show functionality)
router.post([/search-institution-name/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/institution-name-search-results');
})

// Institution ID search results
router.post([/institution-ID-search-results/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/new-s1-s073-entitlement-cya');
})
...
router.post([/institution-ID-search-results-none/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/add-new-institution-details');
})
...
router.post([/add-new-institution-details/], function(req, res){
  res.redirect('/version-33/s1/s072-registration/new-s1-s072-entitlement-cya');
})

// Check your answers
router.post([/new-s1-s072-entitlement-cya/], function(req, res){
  req.session.data['dr-add-s1-entitlement'] = 'yes'
  res.redirect('/version-33/s1/s072-registration/confirmation-s1-s072-added');
})
...
router.post([/add-note/], function(req, res) {
  ...
  res.redirect('/version-33/s1/account/notes');
});
...
// Select entitlement
router.post([/which-entitlement/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/which-s1-entitlement');
})
...
router.post([/which-s1-entitlement/], function(req, res) {
  ...
  if (s1EntitlementType === 'E109') {
    res.redirect('/version-33/s1/account/dependant/s072-registration/entitlement-details');
  } else {
    res.redirect('/version-33/s1/account/dependant/s072-registration/entitlement-for');
  }
})
...
// Select who the entitlement is for
router.post([/entitlement-for/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/entitlement-details');
})

// Input entitlement details
router.post([/entitlement-details/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/search-institution-ID');
})

// Search by institution ID (to show functionality)
router.post([/search-institution-ID/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/institution-ID-search-results');
})

// Search by institution name (to show functionality)
router.post([/search-institution-name/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/institution-name-search-results');
})

// Institution ID search results
router.post([/institution-ID-search-results/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/entitlement-details-cya');
})
...
// Institution ID search results - not found (to show functionality)
router.post([/institution-ID-search-results-none/], function(req, res){
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/add-new-institution-details');
})
...
router.post([/entitlement-details-cya/], function(req, res){
  req.session.data['dr-add-s1-entitlement'] = 'yes'
  res.redirect('/version-33/s1/account/dependant/s1-s072-registration/confirmation-s1-s072-added');
})
...
router.post([/s1-dependant-personal-details/], function(req, res) {
  ...
  res.redirect('/version-33/s1/account/entitlement-content/s1-confirmation-dependant-added');
});
...
router.post([/add-dependant-address/], function(req, res) {
  ...
  if (addDependantAddress === 'yes'){
    res.redirect('/version-33/s1/account/entitlement-content/enter-dependant-address');
  } else {
    res.redirect('/version-33/s1/account/entitlement-content/s1-dependant-details-check');
  }
})
...
router.post([/s1-dependant-details-check/], function(req, res) {
  ...
  if (req.body.action === 'add') {
    res.redirect('/version-33/s1/account/entitlement-content/s1-create-new-dependant-record?number-of-dependants=2');
  } else {
    res.redirect('/version-33/s1/account/entitlement-content/s1-confirmation-dependant-added');
  }
});
...
router.post([/change-basic-personal-details/], function(req, res){
  ...
  res.redirect('/version-33/s1/account/basic-personal-details-comment');
})
...
router.post([/basic-personal-details-comment/], function(req, res){
  ...
  res.redirect('/version-33/s1/account/personal-details');
...
router.post([/change-additional-personal-details/], function(req, res){
  ...
  res.redirect('/version-33/s1/account/additional-personal-details-change-reason');
})
...
router.post([/additional-personal-details-change-reason/], function(req, res){
  ...
  res.redirect('/version-33/s1/account/additional-personal-details-comment');
...
router.post([/change-current-address/], function (req, res) {
  ...
  res.redirect('/version-33/s1/account/change-current-address-comment');
});
...
router.get('/version-33/s1/account/case-history-person', function (req, res) {
  res.render('version-33/s1/account/case-history-person', {
...
router.post([/dr-cancellation-source/], function(req, res) {
  ...
  if (drCancellationSource === 'UK') {
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-entitlement-end-date');
  } else 
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-date-s016-issued');
...
router.post([/dr-entitlement-end-date/], function(req, res) {
  ...
  // Redirect to the next step in the journey
  res.redirect('/version-33/s1/account/dependant/cancellations/dr-cancellation-reason');
});
...
router.post([/dr-cancellation-reason/], (req, res) => {
  ...
  if (drDateCaptureReasons.includes(drCancellationReason)) {
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-enter-date-dynamic'); // Redirect to dynamic date capture screen
  } else if (drCancellationReason === 'The entitlement holder is insured in another country because they have a pension there') {
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-country-pension-awarded');
  } else if ([
    ...
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-additional-comments-optional');
  } else if (drCancellationReason === 'Other') {
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-other-cancellation-reason');
  }
});
...
router.post([/dr-country-pension-awarded/], function(req, res) {
  ...
  res.redirect('/version-33/s1/account/dependant/cancellations/dr-date-state-pension-awarded');
});
...
router.post([/dr-additional-comments-optional/], function (req, res) {
  ...
  const redirectPath = req.session.data['cancelled-by'] === 'UK' 
    ? '/version-33/s1/account/dependant/cancellations/dr-date-s018-sent' 
    : '/version-33/s1/account/dependant/cancellations/dr-date-s017-sent';
...
router.post([/dr-date-s018-sent/], function(req, res) {
  ...
  req.session.data['dr-date-s018-sent-date'] = dateS018Sent;
    ...
    res.redirect('/version-33/s1/account/dependant/cancellations/dr-cancellation-cya');
});
...
router.post([/entitlement-end-date/], function(req, res) {
  ...
  // Redirect to the next step in the journey
  res.redirect('/version-33/s1/account/cancellations/cancellation-reason');
});
...
res.redirect('/version-33/s1/account/document-comments');
...
router.post([/document-comments/], function(req, res){
  ...
  res.redirect('/version-33/s1/account/documents');
