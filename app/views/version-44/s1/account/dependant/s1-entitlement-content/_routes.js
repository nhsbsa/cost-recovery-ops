...
// Change names
// =====================================================
router.post([/dr-change-s1-personal-details/], function(req, res){
  ...
  req.session.data['dr-new-s1-birth-last-names'] = req.body['dr-new-s1-birth-last-name'];
   ...
   const S1DobDay = req.body['dr-new-s1-date-of-birth-day'];
   const S1DobMonth = req.body['dr-new-s1-date-of-birth-month'];
   const S1DobYear = req.body['dr-new-s1-date-of-birth-year'];
   ...
   if (S1DobDay && S1DobMonth && S1DobYear) {
     ...
     S1DobDate = '29 December 1975'; // default if not provided
 }
 
 req.session.data['dr-new-s1-date-of-birth'] = S1DobDate;

  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-reason-for-s1-personal-details-change');
});

router.post([/dr-reason-for-s1-personal-details-change/], function(req, res){
  req.session.data['dr-reason-for-changing-s1-personal-details'] = req.body['dr-reason-for-changing-s1-personal-details'];
  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-personal-details');
});


router.post([/dr-check-before-changing-s1-personal-details/], function(req, res){
  req.session.data['dr-change-s1-personal-details'] = 'yes';
...
router.post([/dr-change-pin-s1/], function (req, res) {
  ...
  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-reason-for-changing-s1-pin');
});
...
router.post([/dr-reason-for-changing-s1-pin/], function(req, res){
  ...
  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-pin');
});
...
router.post([/dr-change-date-of-uk-residency-s1/], function (req, res) {
  ...
  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-reason-for-changing-s1-date-of-uk-residency');
});
...
router.post([/dr-reason-for-changing-s1-date-of-uk-residency/], function(req, res){
  ...
  res.redirect('/version-44/s1/account/dependant/s1-entitlement-content/dr-check-before-changing-s1-date-of-uk-residency');
});
