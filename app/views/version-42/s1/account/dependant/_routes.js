...
router.post([/add-note-dependant/], function(req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/notes');
});
...
router.post([/which-entitlement/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/which-s1-entitlement');
})
...
router.post([/which-s1-entitlement/], function(req, res) {
  ...
  if (s1EntitlementType === 'E109') {
    res.redirect('/version-42/s1/account/dependant/s072-registration/entitlement-details');
  } else {
    res.redirect('/version-42/s1/account/dependant/s072-registration/entitlement-for');
  }
})
...
router.post([/entitlement-for/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/entitlement-details');
})

// Input entitlement details
router.post([/entitlement-details/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/search-institution-ID');
})

// Search by institution ID (to show functionality)
router.post([/search-institution-ID/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/institution-ID-search-results');
})

// Search by institution name (to show functionality)
router.post([/search-institution-name/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/institution-name-search-results');
})

// Institution ID search results
router.post([/institution-ID-search-results/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/entitlement-details-cya');
})
...
router.post([/institution-ID-search-results-none/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/add-new-institution-details');
})
...
router.post([/entitlement-details-cya/], function(req, res){
  ...
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/confirmation-s1-s072-added');
})
...
router.post([/dr-change-personal-details/], function(req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-reason-for-personal-details-change');
})
...
router.post([/dr-reason-for-personal-details-change/], function(req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-check-before-changing-personal-details');
})
...
router.post([/dr-add-additional-personal-details/], function(req, res){
  ...
  res.redirect('/version-42/s1/account/dependant/dr-additional-personal-details-cya');
})
...
router.post([/dr-change-additional-personal-details/], function (req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-reason-for-changing-additional-details');
});
...
router.post([/dr-reason-for-changing-additional-details/], function (req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-check-before-changing-additional-details');
});
...
router.post([/dr-change-current-address/], function (req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-reason-for-current-address-change');
});
...
router.post([/dr-reason-for-current-address-change/], function(req, res) {
  ...
  res.redirect('/version-42/s1/account/dependant/dr-check-before-changing-current-address');
})
