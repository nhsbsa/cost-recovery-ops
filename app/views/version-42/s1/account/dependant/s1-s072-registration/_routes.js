...
router.post([/dr-which-entitlement/], function(req, res){
  ...
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-which-s1-entitlement');
})
...
router.post([/dr-which-s1-entitlement/], function(req, res) {
  ...
  if (drS1EntitlementType === 'E109') {
    res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-entitlement-details');
  } else {
    res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-entitlement-for');
  }
})
...
router.post([/dr-entitlement-details/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-search-institution-ID');
})

// Search by institution ID (to show functionality)
router.post([/dr-search-institution-ID/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-institution-ID-search-results');
})

// Search by institution name (to show functionality)
router.post([/dr-search-institution-name/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-institution-name-search-results');
})

// Institution ID search results
router.post([/dr-institution-ID-search-results/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-entitlement-details-cya');
})
...
router.post([/dr-institution-ID-search-results-none/], function(req, res){
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-add-new-institution-details');
})
...
router.post([/dr-entitlement-details-cya/], function(req, res){
  ...
  res.redirect('/version-42/s1/account/dependant/s1-s072-registration/dr-confirmation-s1-s072-added');
})
