...
router.post([/s1-dependant-personal-details/], function(req, res) {
  ...
  res.redirect('/version-30/s1/account/entitlement-content/s1-confirmation-dependant-added');
});
...
router.post([/s1-dependant-address-same/], function(req, res) {
  ...
  if (sameAddressAsMain === 'yes'){
    res.redirect('/version-30/s1/account/entitlement-content/s1-dependant-details-check');
  } else {
    res.redirect('/version-30/s1/account/entitlement-content/s1-manual-dependant-address');
  }
})
...
router.post([/s1-dependant-details-check/], function(req, res) {
  ...
  if (req.body.action === 'add') {
    res.redirect('/version-30/s1/account/entitlement-content/s1-create-new-dependant-record?number-of-dependants=2');
  } else {
    res.redirect('/version-30/s1/account/entitlement-content/s1-confirmation-dependant-added');
  }
});
...
router.post([/change-basic-personal-details/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/basic-personal-details-comment');
})
...
router.post([/basic-personal-details-comment/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/personal-details');
...
router.post([/change-additional-personal-details/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/additional-personal-details-change-reason');
})
...
router.post([/additional-personal-details-change-reason/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/additional-personal-details-comment');
...
router.post([/change-current-address/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/change-current-address-comment');
...
router.post([/change-current-address-comment/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/case-history');
...
router.post([/change-date-of-residency-uk/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/change-date-of-residency-uk-comment');
...
router.post([/add-contact-details/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/personal-details#tab-contact-details');
...
router.post([/upload-personal-details-document/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/personal-details#tab-documents');
...
router.post([/personal-details-note/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/personal-details#tab-Notes');
...
router.post([/s1-entitlement-note/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/notes');
...
router.post([/change-s1-entitlement-details/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/entitlement-content/s1-entitlement-details#tab-entitlement-details');
...
router.post([/s1-upload-document/], function(req, res){
  ...
  res.redirect('/version-30/s1/account/documents');
...
router.post([/remove-entitlements-document/], function(req, res){
  ...
  if (removeDocument === 'yes') {
      res.redirect('/version-30/s1/account/entitlements-details#tab-Documents')
  } else {
      res.redirect('/version-30/s1/account/entitlements-details#tab-Documents')
  }
