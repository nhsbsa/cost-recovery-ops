...
router.get([/resubmission-summary/], function(req, res) {
  ...
  res.render('version-43/uk-claims/resubmissions/resubmission-summary', {
    data,
    showResubSummary,
    maintainedInvoices,
    withdrawnInvoices,
...
router.post([/create-new-resubmission/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/create-new-resubmission-cya');
});
...
router.get([/create-new-resubmission-cya/], function(req, res) {
  ...
  res.render('version-43/uk-claims/resubmissions/create-new-resubmission-cya', {
...
router.post([/add-invoices-to-resubmission/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/check-invoices-added-to-resubmission');
});
...
router.post([/check-invoices-added-to-resubmission/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/claim-resubmissions');
});
...
router.get([/claim-resubmissions/], function(req, res) {
  ...
  res.render('version-43/uk-claims/resubmissions/claim-resubmissions', {
    data
  });
});
...
router.post([/resubmission-summary/], function (req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/resubmission-summary');
});
...
router.post([/invoice-reasons-for-contestation/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/invoice-reasons-for-contestation?invoice=' + invoice);
});

// Pull through the selected reasons and reload the screen
router.get([/invoice-reasons-for-contestation/], function(req, res) {
  res.render('version-43/uk-claims/resubmissions/invoice-reasons-for-contestation', {
    data: req.session.data
  });
});
...
router.post([/enter-revised-accounting-period/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/reasons-to-partially-maintain-and-withdraw-months');
});
...
router.post([/reasons-to-partially-maintain-and-withdraw-months/], function(req, res) {
  ...
  if (reasonToPartiallyMaintainAndWithdrawMonths === 'Information requested updated [04]') {
    return res.redirect('/version-43/uk-claims/resubmissions/select-information-requested-partially-maintain-and-withdraw');
  }

  // Redirect to select the source of the partial withdrawal request
  res.redirect('/version-43/uk-claims/resubmissions/source-of-partial-withdrawal');
});
...
router.post([/source-of-partial-withdrawal/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/partial-additional-comments');
});
...
router.post([/partial-additional-comments/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/cya-partial-maintain-and-partial-withdraw');
});

// Pull through the input data onto the cya screen
router.get([/cya-partial-maintain-and-partial-withdraw/], function(req, res) {
  res.render('version-43/uk-claims/resubmissions/cya-partial-maintain-and-partial-withdraw', {
    data: req.session.data
  });
});
...
router.post([/cya-partial-maintain-and-partial-withdraw/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/invoices-within-resubmission');
});
...
router.post([/source-of-withdrawal/], function(req, res) {
  ...
  res.redirect('/version-43/uk-claims/resubmissions/reasons-to-withdraw-months');
});
...
router.post([/reasons-to-withdraw-months/], function(req, res) {
  ...
  // Redirect to add additional comments (optional)
  res.redirect('/version-43/uk-claims/resubmissions/withdraw-additional-comments');
});
...
router.post([/withdraw-additional-comments/], function(req, res) {
  ...
  // Redirect to the resubmission page
  res.redirect('/version-43/uk-claims/resubmissions/cya-withdraw');
});
...
router.post([/reasons-to-maintain-months/], function(req, res) {
  ...
  if (reasonToMaintainMonths === 'Information requested updated [04]') {
    return res.redirect('/version-43/uk-claims/resubmissions/select-information-requested-maintain');
  }

  // Redirect to check your answers (maintain)
  res.redirect('/version-43/uk-claims/resubmissions/maintain-additional-comments');
});
...
router.post([/maintain-additional-comments/], function(req, res) {
  ...
  // Redirect to the resubmission page
  res.redirect('/version-43/uk-claims/resubmissions/cya-maintain');
});

// Pull through the input data onto the cya screen
router.get([/cya-maintain/], function(req, res) {
  res.render('version-43/uk-claims/resubmissions/cya-maintain', {
    data: req.session.data
  });
});
...
router.get([/invoices-within-resubmission/], function (req, res) {
  ...
  res.render('version-43/uk-claims/resubmissions/invoices-within-resubmission', {
    data
  });
});

router.get([/invoice-details/], function(req, res) {
  res.render('version-43/uk-claims/resubmissions/invoice-details', {
    data: req.session.data
  });
});
...
router.post([/invoice-upload-evidence/], function(req, res) {
  ...
  if (uploadAdditionalEvidence === 'yes'){
    res.redirect('/version-43/uk-claims/resubmissions/invoice-upload-additional-evidence?more-evidence=yes')
  } else {
    res.redirect('/version-43/uk-claims/resubmissions/invoice-upload-additional-evidence')
  }
...
router.post([/invoice-upload-additional-evidence/], function(req, res) {
  ...
  if (uploadAdditionalEvidence === 'yes'){
    res.redirect('/version-43/uk-claims/resubmissions/invoice-upload-evidence?upload-additional-evidence=yes')
  } else {
    res.redirect('/version-43/uk-claims/resubmissions/check-uploaded-invoice-evidence')
  }
...
router.post([/check-uploaded-invoice-evidence/], function(req, res) {
  ...
  // Redirect to the resubmission page
  res.redirect('/version-43/uk-claims/resubmissions/invoice-evidence');
});
...
router.get([/resubmission-history/], function (req, res) {
  ...
  res.render('version-43/uk-claims/resubmissions/resubmission-history', {
    data,
    showSentToMSRow,
    showUploadedToDHRow,
