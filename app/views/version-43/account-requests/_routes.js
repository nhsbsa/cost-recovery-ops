...
res.redirect('/version-43/account-requests/pending-requests');
...
router.post([/reason-for-account-rejection/], function(req, res){
    ...
    res.redirect('/version-43/account-requests/rejected-requests');
...
res.redirect('/version-43/account-requests/cancel-account');
