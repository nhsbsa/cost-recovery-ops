...
res.redirect('/version-43/non-eu-reciprocal-healthcare/treatment-end-date');
...
res.redirect('/version-43/non-eu-reciprocal-healthcare/treatment-cost');
...
res.redirect('/version-43/non-eu-reciprocal-healthcare/select-country');
});
...
res.redirect('/version-43/non-eu-reciprocal-healthcare/enter-quota-number');
});
...
// Redirect to check your answers
res.redirect('/version-43/non-eu-reciprocal-healthcare/patient-details');
});
...
// Redirect to check your answers
res.redirect('/version-43/non-eu-reciprocal-healthcare/add-treatment-cya');
});
...
res.redirect('/version-43/non-eu-reciprocal-healthcare/confirmation-treatment-added');
});
...
// Redirect to confirmation treatment added screen
res.redirect('/version-43/non-eu-reciprocal-healthcare/home');
});
