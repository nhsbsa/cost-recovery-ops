...
router.post([/cancellation-details/], (req, res) => {
  ...
  res.redirect('/version-46/s1/account/cancellations/additional-comments-optional');
});
...
router.post([/additional-comments-optional/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/cancellations/cancellation-cya');
...
router.post([/cancellation-cya/], function(req, res) {
  ...
  if (entitlementEndDate === '06/02/2020') {
      res.redirect('/version-46/s1/account/entitlement-content/expired-s1-entitlement-details');
  } else {
