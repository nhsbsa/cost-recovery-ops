...
router.post([/s1-dependant-personal-details/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/entitlement-content/s1-confirmation-dependant-added');
});
...
router.post([/add-dependant-address/], function(req, res) {
  ...
  if (addDependantAddress === 'yes'){
    res.redirect('/version-46/s1/account/entitlement-content/enter-dependant-address');
  } else {
    res.redirect('/version-46/s1/account/entitlement-content/s1-dependant-details-check');
  }
});
...
router.post([/s1-dependant-details-check/], function(req, res) {
  ...
  if (req.body.action === 'add') {
    res.redirect('/version-46/s1/account/entitlement-content/s1-create-new-dependant-record?number-of-dependants=2');
  } else {
    res.redirect('/version-46/s1/account/entitlement-content/s1-confirmation-dependant-added');
  }
});
...
req.session.data['new-s1-date-of-birth'] = S1DobDate;
  ...
  res.redirect('/version-46/s1/account/entitlement-content/reason-for-s1-personal-details-change');
});
...
router.post([/reason-for-s1-personal-details-change/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/entitlement-content/check-before-changing-s1-personal-details');
});
...
router.post([/check-before-changing-s1-personal-details/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/entitlement-content/s1-entitlement-details');
});
...
router.post([/change-pin-s1/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/entitlement-content/reason-for-changing-s1-pin');
});
...
router.post([/reason-for-changing-s1-pin/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/entitlement-content/check-before-changing-s1-pin');
});
...
router.post([/change-date-of-uk-residency-s1/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/entitlement-content/reason-for-changing-s1-date-of-uk-residency');
});
...
router.post([/reason-for-changing-s1-date-of-uk-residency/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/entitlement-content/check-before-changing-s1-date-of-uk-residency');
});
...
// =====================================================
router.get('/version-46/s1/account/entitlement-content/s1-entitlement-details', function (req, res) {
  res.render('version-46/s1/account/entitlement-content/s1-entitlement-details', { data: req.session.data });
});

// View case history section for entitlements
router.get('/version-46/s1/account/case-history-entitlements', function (req, res) {
  res.render('version-46/s1/account/case-history-entitlements', {
...
// =====================================================
// Change institution details on an S1 entitlement
// =====================================================

// Search for the institution by ID
router.post([/change-s1-institution-details-search-by-id/], function(req, res) {

  res.redirect('/version-46/s1/account/entitlement-content/change-s1-institution-details-search-by-id-results');
})

// Search for the institution by name
router.post([/change-s1-institution-details-search-by-name/], function(req, res) {

  res.redirect('/version-46/s1/account/entitlement-content/change-s1-institution-details-search-by-name-results');
})

// Enter the reason for changing the instituion details
router.post([/reason-for-changing-s1-institution-details/], function(req, res){
  req.session.data['reason-for-changing-s1-institution-details'] = req.body['reason-for-changing-s1-institution-details'];
  res.redirect('/version-46/s1/account/entitlement-content/cya-before-changing-s1-institution-details');
});

router.post([/cya-before-changing-s1-institution-details/], function (req, res) {
  req.session.data['change-s1-institution-details'] = 'yes';
  res.redirect('/version-46/s1/account/entitlement-content/s1-entitlement-details');
});
