...
router.post([/add-note-dependant/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/notes');
});
...
router.post([/dr-link-to-entitlement-cya/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/dependant/s1-entitlement-content/s1-entitlement-details');
})
...
router.post([/dr-which-entitlement/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-which-s1-entitlement');
})
...
router.post([/dr-which-s1-entitlement/], function(req, res) {
  ...
  if (s1EntitlementType === 'E109') {
    res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-entitlement-details');
  } else {
    res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-entitlement-for');
  }
})
...
router.post([/dr-entitlement-details/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-search-institution-ID');
})

// Search by institution ID (to show functionality)
router.post([/dr-search-institution-ID/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-institution-ID-search-results');
})

// Search by institution name (to show functionality)
router.post([/dr-search-institution-name/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-institution-name-search-results');
})

// Institution ID search results
router.post([/dr-institution-ID-search-results/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-entitlement-details-cya');
})
...
router.post([/dr-institution-ID-search-results-none/], function(req, res){
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-add-new-institution-details');
})
...
router.post([/dr-entitlement-details-cya/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/dependant/s1-s072-registration/dr-confirmation-s1-s072-added');
})
...
router.post([/dr-cancellation-details/], (req, res) => {
  ...
  res.redirect('/version-46/s1/account/dependant/cancellations/dr-additional-comments-optional');
});
...
router.post([/dr-additional-comments-optional/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/cancellations/dr-cancellation-cya');
...
router.post([/dr-change-personal-details/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-reason-for-personal-details-change');
})
...
router.post([/dr-reason-for-personal-details-change/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-check-before-changing-personal-details');
})
...
router.post([/dr-check-before-changing-personal-details/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/personal-details');
})
...
router.post([/dr-add-additional-personal-details/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/dependant/dr-additional-personal-details-cya');
})
...
router.post([/dr-change-additional-personal-details/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-reason-for-changing-additional-details');
});
...
router.post([/dr-reason-for-changing-additional-details/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-check-before-changing-additional-details');
});
...
router.post([/dr-change-current-address/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-reason-for-current-address-change');
});
...
router.post([/dr-reason-for-current-address-change/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/dr-check-before-changing-current-address');
})
