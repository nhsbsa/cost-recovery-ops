...
router.post([/dr-continue-generating-s071/], function(req, res) {
  ...
  if (drContinueToGenerateS071 === 'Yes') {
    res.redirect('/version-46/s1/account/dependant/generate-s071/dr-select-citizen-status')
  } else {
    res.redirect('/version-46/s1/account/dependant/s1-requests')
  }
})
...
router.post([/dr-select-citizen-status/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-request-for-e109');
})
...
router.post([/dr-request-for-e109/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-enter-date-of-uk-residency');
});
...
router.post([/dr-enter-date-of-uk-residency/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-enter-member-state-details');
})
...
router.post([/dr-enter-member-state-details/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-search-for-institution-by-id');
})

// Search for the institution by ID
router.post([/dr-search-for-institution-by-id/], function(req, res) {

  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-search-for-institution-by-id-results');
})

// Search for the institution by name
router.post([/dr-search-for-institution-by-name/], function(req, res) {

  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-search-for-institution-by-name-results');
})
...
router.post([/dr-enter-entitlement-period/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-cya-generate-s071');
})

// Check your answers before generating the S071
router.post([/dr-cya-generate-s071/], function(req, res) {

  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-search-for-main-insured');
})

// View new S071 in the 'Documents' section
router.post([/dr-search-for-main-insured/], function(req, res) {

  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-search-for-main-insured-results');
})
...
router.post([/dr-enter-main-insured-pin/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-cya-link-main-insured');
})
...
if (journeyStartedFromDocumentsSection === 'Yes') {
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-confirmation-main-insured-linked')
} else {
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-confirmation-s071-generated')
}
})
...
router.post([/dr-confirmation-s071-generated/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/dependant/generate-s071/dr-review-institution-details');
})
...
router.post([/dr-review-institution-details/], function(req, res) {
  ...
  if (drSendS071ToMemberState === 'Yes') {
    ...
    res.redirect('/version-46/s1/account/dependant/generate-s071/dr-confirmation-s071-sent-to-ms')
  } else {
    res.redirect('/version-46/s1/account/dependant/system-generated-documents')
  }
})
...
router.get([/dr-cancel-generate-s071/], function (req, res) {
  ...
  res.render('version-46/s1/account/dependant/generate-s071/dr-cancel-generate-s071')
})
