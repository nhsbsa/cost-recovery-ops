...
router.post('/enter-date-s071-sent-to-ms', function(req, res) {
  ...
  req.session.data['s071-sent-to-ms-rina-ref'] = s071SentToMSRINARef;


  // Redirect to enter the RINA reference for sending the S071 to the Member State
  res.redirect('/version-46/s1/account/cya-s071-confirmation');
})
...
router.post([/add-note/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/notes');
});
...
req.session.data['new-date-of-birth'] = dobDate;
  ...
  res.redirect('/version-46/s1/account/reason-for-personal-details-change');
})
...
router.post([/reason-for-personal-details-change/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/check-before-changing-personal-details');
})
...
router.post([/check-before-changing-personal-details/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/personal-details');
})
...
router.post([/change-additional-personal-details/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/reason-for-changing-additional-details');
});
...
router.post([/reason-for-changing-additional-details/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/check-before-changing-additional-details');
});
...
router.post([/change-current-address/], function (req, res) {
  ...
  res.redirect('/version-46/s1/account/reason-for-current-address-change');
});
...
router.post([/reason-for-current-address-change/], function(req, res) {
  ...
  res.redirect('/version-46/s1/account/check-before-changing-current-address');
})
...
res.redirect('/version-46/s1/account/document-comments');
...
router.post([/document-comments/], function(req, res){
  ...
  res.redirect('/version-46/s1/account/documents');
