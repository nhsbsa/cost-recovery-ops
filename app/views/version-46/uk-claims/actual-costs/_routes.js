...
router.get([/resubmission-summary/], function(req, res) {
  ...
  res.render('version-46/uk-claims/actual-costs/resubmission-summary', {
    data,
    showResubSummary,
...
router.post([/claim-summary/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/claim-history');
});

// Pull through the input data onto the Claim history screen
router.get([/claim-history/], function(req, res) {
  res.render('version-46/uk-claims/actual-costs/claim-history', {
...
router.post([/create-new-actual-cost-resubmission/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/confirmation-actual-cost-resubmission-created');
});
...
router.post([/confirmation-actual-cost-resubmission-created/], function(req, res) {
  ...
  res.redirect('/version-46/resubmissions/pending-resubmissions');
});
...
router.post([/add-treatments-to-resubmission/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/check-treatment-added-to-resubmission');
});
...
router.post([/check-treatments-added-to-resubmission/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/resubmissions');
});
...
router.get([/resubmissions/], function(req, res) {
  ...
  res.render('version-46/uk-claims/actual-costs/resubmissions', {
    data
  });
});
...
router.post([/resubmission-summary/], function (req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/resubmission-summary');
});
...
router.post([/treatment-upload-evidence/], function(req, res) {
  ...
  if (uploadAdditionalEvidence === 'yes'){
    res.redirect('/version-46/uk-claims/actual-costs/treatment-upload-additional-evidence?more-evidence=yes')
  } else {
    res.redirect('/version-46/uk-claims/actual-costs/treatment-upload-additional-evidence')
  }
...
router.post([/treatment-upload-additional-evidence/], function(req, res) {
  ...
  if (uploadAdditionalEvidence === 'yes'){
    res.redirect('/version-46/uk-claims/actual-costs/treatment-upload-evidence?upload-additional-evidence=yes')
  } else {
    res.redirect('/version-46/uk-claims/actual-costs/check-uploaded-treatment-evidence')
  }
...
router.post([/check-uploaded-treatment-evidence/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/treatment-evidence');
});
...
router.post([/reasons-to-maintain-treatment-cost/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/cya-maintain-treatment-cost');
});


// Pull through the input data onto the cya screen
router.get([/cya-maintain-treatment-cost/], function(req, res) {
  res.render('version-46/uk-claims/actual-costs/cya-maintain-treatment-cost', {
    data: req.session.data
  });
});
...
router.post([/cya-maintain-treatment-cost/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/treatments-within-resubmission');
});
...
router.post([/source-of-treatment-withdrawal/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/reasons-to-withdraw-treatment-cost');
});
...
router.post([/reasons-to-withdraw-treatment-cost/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/cya-withdraw-treatment-cost');
});
...
router.post([/enter-maintained-treatment-dates/], function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/confirm-maintained-and-withdrawn-costs');
});
...
router.post([/confirm-maintained-and-withdrawn-costs/], function(req, res) {
  ...
  // Redirect to the confirm partial
  res.redirect('/version-46/uk-claims/actual-costs/reasons-to-partially-maintain-treatment-cost');
});
...
router.post([/reasons-to-partially-maintain-treatment-cost/], function(req, res) {
  ...
  // Redirect to add additional comments (optional)
  res.redirect('/version-46/uk-claims/actual-costs/source-of-partial-treatment-withdrawal');
});
...
router.post([/source-of-partial-treatment-withdrawal/], function(req, res) {
  ...
  // Redirect to select the reasons for withdrawing treatment cost claimed
  res.redirect('/version-46/uk-claims/actual-costs/reasons-to-partially-withdraw-treatment-cost');
});
...
router.post([/reasons-to-partially-withdraw-treatment-cost/], function(req, res) {
  ...
  // Redirect to cya
  res.redirect('/version-46/uk-claims/actual-costs/cya-partially-maintain-and-withdraw-treatment-cost');
});
...
router.get([/treatments-within-resubmission/], function (req, res) {
  ...
  res.render('version-46/uk-claims/actual-costs/treatments-within-resubmission', {
    data
  });
});

router.get([/treatment-details/], function(req, res) {
  res.render('version-46/uk-claims/actual-costs/treatment-details', {
    data: req.session.data
  });
});
...
router.post('/treatment-reasons-for-contestation', function(req, res) {
  ...
  if (requiresAdditionalDetails) {
    ...
    res.redirect('/version-46/uk-claims/actual-costs/enter-additional-details-from-ms');
...
router.post('/enter-additional-details-from-ms', function(req, res) {
  ...
  res.redirect('/version-46/uk-claims/actual-costs/cya-reason-for-contestation');
});
...
router.post('/request-additional-information-from-ovm', function(req, res) {
  ...
  if (requestAdditionalInformationFromOVM === 'Yes'){
    res.redirect('/version-46/uk-claims/actual-costs/reason-for-additional-info-from-ovm')
  } else {
    res.redirect('/version-46/uk-claims/actual-costs/contact-ovm')
  }
...
router.post('/request-prc', function(req, res) {
  ...
  // Redirect to cya screen
  res.redirect('/version-46/uk-claims/actual-costs/cya-request-prc');
});
...
router.post('/cya-request-prc', function(req, res) {
  ...
  // Redirect to the Request a PRC screen
  res.redirect('/version-46/uk-claims/actual-costs/request-prc');
});
