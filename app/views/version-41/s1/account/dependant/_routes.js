...
router.post([/add-note-dependant/], function(req, res) {
  ...
  res.redirect('/version-41/s1/account/dependant/notes');
});
...
router.post([/dr-cancellation-details/], (req, res) => {
  ...
  res.redirect('/version-41/s1/account/dependant/cancellations/dr-additional-comments-optional');
});
...
router.post([/dr-additional-comments-optional/], function (req, res) {
  ...
  res.redirect('/version-41/s1/account/dependant/cancellations/dr-cancellation-cya');
...
router.post([/dr-change-personal-details/], function(req, res) {
  ...
  res.redirect('/version-41/s1/account/dependant/dr-reason-for-personal-details-change');
})
...
router.post([/dr-reason-for-personal-details-change/], function(req, res) {
  ...
  res.redirect('/version-41/s1/account/dependant/dr-check-before-changing-personal-details');
})
...
router.post([/dr-add-current-address/], function (req, res) {
  ...
  res.redirect('/version-41/s1/account/dependant/dr-check-before-adding-current-address');
});
...
router.post([/dr-change-current-address/], function (req, res) {
  ...
  // Redirect to the check-your-answers screen
  res.redirect('/version-41/s1/account/dependant/dr-reason-for-current-address-change');
});
