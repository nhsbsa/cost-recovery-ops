...
router.post([/person-search/], function(req, res){
  res.redirect('/version-41/s1/account/entitlement-content/person-search-results');
})

// Search results
router.post([/person-search-results/], function(req, res){
  res.redirect('/version-41/s1/account/entitlement-content/dependant-person-summary');
})
...
router.post([/change-basic-personal-details/], function(req, res){
  ...
  res.redirect('/version-41/s1/account/basic-personal-details-comment');
})
...
router.post([/change-current-address/], function (req, res) {
  ...
  res.redirect('/version-41/s1/account/change-current-address-comment');
});
